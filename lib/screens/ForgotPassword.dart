        ...
        body: Container(
          ...
          child: LayoutBuilder(builder: (context,constraint){
            return Column(
              ...
              children: [
                Container(height: 10.h,child:Center(child: Text("Please verify your email before password reset",style: TextStyle(color: isDarkMode?Colors.white:Colors.black,fontSize: 16.sp),textAlign: TextAlign.center,))),
                Container(
                  height: 70.h,
                  child: Form(
                    key: _formKey,
                              ...
                              if(_formKey.currentState!.validate())
                                {
                                        ...
                                        if(b)
                                              ...
                                              Get.to(()=>OtpForgotPassword( email: emailController.text,) );
